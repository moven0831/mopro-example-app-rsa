...
fileprivate extension RustBuffer {
    ...
    static func from(_ ptr: UnsafeBufferPointer<UInt8>) -> RustBuffer {
        try! rustCall { ffi_mopro_example_app_rsa_rustbuffer_from_bytes(ForeignBytes(bufferPointer: ptr), $0) }
    }

    // Frees the buffer in place.
    // The buffer must not be used after this is called.
    func deallocate() {
        try! rustCall { ffi_mopro_example_app_rsa_rustbuffer_free(self, $0) }
    }
}
...
private func makeRustCall<T, E: Swift.Error>(
    ...
    uniffiEnsureMoproExampleAppRsaInitialized()
...
public func generateCircomProof(zkeyPath: String, circuitInputs: String, proofLib: ProofLib)throws  -> CircomProofResult  {
    ...
    uniffi_mopro_example_app_rsa_fn_func_generate_circom_proof(
...
public func generateHalo2Proof(srsPath: String, pkPath: String, circuitInputs: [String: [String]])throws  -> Halo2ProofResult  {
    ...
    uniffi_mopro_example_app_rsa_fn_func_generate_halo2_proof(
...
public func generateNoirProof(circuitPath: String, srsPath: String?, inputs: [String])throws  -> Data  {
    ...
    uniffi_mopro_example_app_rsa_fn_func_generate_noir_proof(
...
public func proveRsaSimple(srsPath: String, inputs: [String]) -> Data  {
    return try!  FfiConverterData.lift(try! rustCall() {
    uniffi_mopro_example_app_rsa_fn_func_prove_rsa_simple(
        FfiConverterString.lower(srsPath),
        FfiConverterSequenceString.lower(inputs),$0
    )
})
...
public func verifyCircomProof(zkeyPath: String, proofResult: CircomProofResult, proofLib: ProofLib)throws  -> Bool  {
    ...
    uniffi_mopro_example_app_rsa_fn_func_verify_circom_proof(
        FfiConverterString.lower(zkeyPath),
...
public func verifyHalo2Proof(srsPath: String, vkPath: String, proof: Data, publicInput: Data)throws  -> Bool  {
    return try  FfiConverterBool.lift(try rustCallWithError(FfiConverterTypeMoproError_lift) {
    uniffi_mopro_example_app_rsa_fn_func_verify_halo2_proof(
        FfiConverterString.lower(srsPath),
...
public func verifyNoirProof(circuitPath: String, proof: Data)throws  -> Bool  {
    return try  FfiConverterBool.lift(try rustCallWithError(FfiConverterTypeMoproError_lift) {
    uniffi_mopro_example_app_rsa_fn_func_verify_noir_proof(
        FfiConverterString.lower(circuitPath),
        FfiConverterData.lower(proof),$0
    )
})
}
public func verifyRsaSimple(srsPath: String, proof: Data) -> Bool  {
    return try!  FfiConverterBool.lift(try! rustCall() {
    uniffi_mopro_example_app_rsa_fn_func_verify_rsa_simple(
        FfiConverterString.lower(srsPath),
        FfiConverterData.lower(proof),$0
    )
})
...
private let initializationResult: InitializationResult = {
    ...
    let scaffolding_contract_version = ffi_mopro_example_app_rsa_uniffi_contract_version()
    if bindings_contract_version != scaffolding_contract_version {
        return InitializationResult.contractVersionMismatch
    }
    if (uniffi_mopro_example_app_rsa_checksum_func_generate_circom_proof() != 18036) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_mopro_example_app_rsa_checksum_func_generate_halo2_proof() != 2252) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_mopro_example_app_rsa_checksum_func_generate_noir_proof() != 65329) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_mopro_example_app_rsa_checksum_func_prove_rsa_simple() != 62967) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_mopro_example_app_rsa_checksum_func_verify_circom_proof() != 20320) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_mopro_example_app_rsa_checksum_func_verify_halo2_proof() != 26388) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_mopro_example_app_rsa_checksum_func_verify_noir_proof() != 23376) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_mopro_example_app_rsa_checksum_func_verify_rsa_simple() != 38286) {
        return InitializationResult.apiChecksumMismatch
    }
...
public func uniffiEnsureMoproExampleAppRsaInitialized() {
