    ...
    companion object {
        internal fun alloc(size: ULong = 0UL) =
            uniffiRustCall { status ->
                ...
                UniffiLib.INSTANCE.ffi_mopro_example_app_rsa_rustbuffer_alloc(size.toLong(), status)
            }.also {
                if (it.data == null) {
        ...
        internal fun free(buf: RustBuffer.ByValue) =
            uniffiRustCall { status ->
                UniffiLib.INSTANCE.ffi_mopro_example_app_rsa_rustbuffer_free(buf, status)
            }
    }
...
internal interface IntegrityCheckingUniffiLib : Library {
    ...
    fun uniffi_mopro_example_app_rsa_checksum_func_generate_circom_proof(): Short

    fun uniffi_mopro_example_app_rsa_checksum_func_generate_halo2_proof(): Short

    fun uniffi_mopro_example_app_rsa_checksum_func_generate_noir_proof(): Short

    fun uniffi_mopro_example_app_rsa_checksum_func_prove_rsa_simple(): Short

    fun uniffi_mopro_example_app_rsa_checksum_func_verify_circom_proof(): Short

    fun uniffi_mopro_example_app_rsa_checksum_func_verify_halo2_proof(): Short

    fun uniffi_mopro_example_app_rsa_checksum_func_verify_noir_proof(): Short

    fun uniffi_mopro_example_app_rsa_checksum_func_verify_rsa_simple(): Short

    fun ffi_mopro_example_app_rsa_uniffi_contract_version(): Int
}
...
internal interface UniffiLib : Library {
    ...
    // FFI functions
    fun uniffi_mopro_example_app_rsa_fn_func_generate_circom_proof(
    ...
    fun uniffi_mopro_example_app_rsa_fn_func_generate_halo2_proof(
    ...
    fun uniffi_mopro_example_app_rsa_fn_func_generate_noir_proof(
    ...
    fun uniffi_mopro_example_app_rsa_fn_func_prove_rsa_simple(
        `srsPath`: RustBuffer.ByValue,
        `inputs`: RustBuffer.ByValue,
        uniffi_out_err: UniffiRustCallStatus,
    ): RustBuffer.ByValue

    fun uniffi_mopro_example_app_rsa_fn_func_verify_circom_proof(
        `zkeyPath`: RustBuffer.ByValue,
    ...
    fun uniffi_mopro_example_app_rsa_fn_func_verify_halo2_proof(
        `srsPath`: RustBuffer.ByValue,
    ...
    fun uniffi_mopro_example_app_rsa_fn_func_verify_noir_proof(
        `circuitPath`: RustBuffer.ByValue,
        `proof`: RustBuffer.ByValue,
        uniffi_out_err: UniffiRustCallStatus,
    ): Byte

    fun uniffi_mopro_example_app_rsa_fn_func_verify_rsa_simple(
        `srsPath`: RustBuffer.ByValue,
        `proof`: RustBuffer.ByValue,
        uniffi_out_err: UniffiRustCallStatus,
    ): Byte

    fun ffi_mopro_example_app_rsa_rustbuffer_alloc(
        `size`: Long,
        uniffi_out_err: UniffiRustCallStatus,
    ): RustBuffer.ByValue

    fun ffi_mopro_example_app_rsa_rustbuffer_from_bytes(
        `bytes`: ForeignBytes.ByValue,
        uniffi_out_err: UniffiRustCallStatus,
    ): RustBuffer.ByValue

    fun ffi_mopro_example_app_rsa_rustbuffer_free(
        `buf`: RustBuffer.ByValue,
        uniffi_out_err: UniffiRustCallStatus,
    ): Unit

    fun ffi_mopro_example_app_rsa_rustbuffer_reserve(
        `buf`: RustBuffer.ByValue,
        `additional`: Long,
        uniffi_out_err: UniffiRustCallStatus,
    ): RustBuffer.ByValue

    fun ffi_mopro_example_app_rsa_rust_future_poll_u8(
        `handle`: Long,
        `callback`: UniffiRustFutureContinuationCallback,
        `callbackData`: Long,
    ): Unit

    fun ffi_mopro_example_app_rsa_rust_future_cancel_u8(`handle`: Long): Unit

    fun ffi_mopro_example_app_rsa_rust_future_free_u8(`handle`: Long): Unit

    fun ffi_mopro_example_app_rsa_rust_future_complete_u8(
        `handle`: Long,
        uniffi_out_err: UniffiRustCallStatus,
    ): Byte

    fun ffi_mopro_example_app_rsa_rust_future_poll_i8(
        `handle`: Long,
        `callback`: UniffiRustFutureContinuationCallback,
        `callbackData`: Long,
    ): Unit

    fun ffi_mopro_example_app_rsa_rust_future_cancel_i8(`handle`: Long): Unit

    fun ffi_mopro_example_app_rsa_rust_future_free_i8(`handle`: Long): Unit

    fun ffi_mopro_example_app_rsa_rust_future_complete_i8(
        `handle`: Long,
        uniffi_out_err: UniffiRustCallStatus,
    ): Byte

    fun ffi_mopro_example_app_rsa_rust_future_poll_u16(
        `handle`: Long,
        `callback`: UniffiRustFutureContinuationCallback,
        `callbackData`: Long,
    ): Unit

    fun ffi_mopro_example_app_rsa_rust_future_cancel_u16(`handle`: Long): Unit

    fun ffi_mopro_example_app_rsa_rust_future_free_u16(`handle`: Long): Unit

    fun ffi_mopro_example_app_rsa_rust_future_complete_u16(
        `handle`: Long,
        uniffi_out_err: UniffiRustCallStatus,
    ): Short

    fun ffi_mopro_example_app_rsa_rust_future_poll_i16(
        `handle`: Long,
        `callback`: UniffiRustFutureContinuationCallback,
        `callbackData`: Long,
    ): Unit

    fun ffi_mopro_example_app_rsa_rust_future_cancel_i16(`handle`: Long): Unit

    fun ffi_mopro_example_app_rsa_rust_future_free_i16(`handle`: Long): Unit

    fun ffi_mopro_example_app_rsa_rust_future_complete_i16(
        `handle`: Long,
        uniffi_out_err: UniffiRustCallStatus,
    ): Short

    fun ffi_mopro_example_app_rsa_rust_future_poll_u32(
        `handle`: Long,
        `callback`: UniffiRustFutureContinuationCallback,
        `callbackData`: Long,
    ): Unit

    fun ffi_mopro_example_app_rsa_rust_future_cancel_u32(`handle`: Long): Unit

    fun ffi_mopro_example_app_rsa_rust_future_free_u32(`handle`: Long): Unit

    fun ffi_mopro_example_app_rsa_rust_future_complete_u32(
        `handle`: Long,
        uniffi_out_err: UniffiRustCallStatus,
    ): Int

    fun ffi_mopro_example_app_rsa_rust_future_poll_i32(
        `handle`: Long,
        `callback`: UniffiRustFutureContinuationCallback,
        `callbackData`: Long,
    ): Unit

    fun ffi_mopro_example_app_rsa_rust_future_cancel_i32(`handle`: Long): Unit

    fun ffi_mopro_example_app_rsa_rust_future_free_i32(`handle`: Long): Unit

    fun ffi_mopro_example_app_rsa_rust_future_complete_i32(
        `handle`: Long,
        uniffi_out_err: UniffiRustCallStatus,
    ): Int

    fun ffi_mopro_example_app_rsa_rust_future_poll_u64(
        `handle`: Long,
        `callback`: UniffiRustFutureContinuationCallback,
        `callbackData`: Long,
    ): Unit

    fun ffi_mopro_example_app_rsa_rust_future_cancel_u64(`handle`: Long): Unit

    fun ffi_mopro_example_app_rsa_rust_future_free_u64(`handle`: Long): Unit

    fun ffi_mopro_example_app_rsa_rust_future_complete_u64(
        `handle`: Long,
        uniffi_out_err: UniffiRustCallStatus,
    ): Long

    fun ffi_mopro_example_app_rsa_rust_future_poll_i64(
        `handle`: Long,
        `callback`: UniffiRustFutureContinuationCallback,
        `callbackData`: Long,
    ): Unit

    fun ffi_mopro_example_app_rsa_rust_future_cancel_i64(`handle`: Long): Unit

    fun ffi_mopro_example_app_rsa_rust_future_free_i64(`handle`: Long): Unit

    fun ffi_mopro_example_app_rsa_rust_future_complete_i64(
        `handle`: Long,
        uniffi_out_err: UniffiRustCallStatus,
    ): Long

    fun ffi_mopro_example_app_rsa_rust_future_poll_f32(
        `handle`: Long,
        `callback`: UniffiRustFutureContinuationCallback,
        `callbackData`: Long,
    ): Unit

    fun ffi_mopro_example_app_rsa_rust_future_cancel_f32(`handle`: Long): Unit

    fun ffi_mopro_example_app_rsa_rust_future_free_f32(`handle`: Long): Unit

    fun ffi_mopro_example_app_rsa_rust_future_complete_f32(
        `handle`: Long,
        uniffi_out_err: UniffiRustCallStatus,
    ): Float

    fun ffi_mopro_example_app_rsa_rust_future_poll_f64(
        `handle`: Long,
        `callback`: UniffiRustFutureContinuationCallback,
        `callbackData`: Long,
    ): Unit

    fun ffi_mopro_example_app_rsa_rust_future_cancel_f64(`handle`: Long): Unit

    fun ffi_mopro_example_app_rsa_rust_future_free_f64(`handle`: Long): Unit

    fun ffi_mopro_example_app_rsa_rust_future_complete_f64(
        `handle`: Long,
        uniffi_out_err: UniffiRustCallStatus,
    ): Double

    fun ffi_mopro_example_app_rsa_rust_future_poll_pointer(
        `handle`: Long,
        `callback`: UniffiRustFutureContinuationCallback,
        `callbackData`: Long,
    ): Unit

    fun ffi_mopro_example_app_rsa_rust_future_cancel_pointer(`handle`: Long): Unit

    fun ffi_mopro_example_app_rsa_rust_future_free_pointer(`handle`: Long): Unit

    fun ffi_mopro_example_app_rsa_rust_future_complete_pointer(
        `handle`: Long,
        uniffi_out_err: UniffiRustCallStatus,
    ): Pointer

    fun ffi_mopro_example_app_rsa_rust_future_poll_rust_buffer(
        `handle`: Long,
        `callback`: UniffiRustFutureContinuationCallback,
        `callbackData`: Long,
    ): Unit

    fun ffi_mopro_example_app_rsa_rust_future_cancel_rust_buffer(`handle`: Long): Unit

    fun ffi_mopro_example_app_rsa_rust_future_free_rust_buffer(`handle`: Long): Unit

    fun ffi_mopro_example_app_rsa_rust_future_complete_rust_buffer(
        `handle`: Long,
        uniffi_out_err: UniffiRustCallStatus,
    ): RustBuffer.ByValue

    fun ffi_mopro_example_app_rsa_rust_future_poll_void(
        `handle`: Long,
        `callback`: UniffiRustFutureContinuationCallback,
        `callbackData`: Long,
    ): Unit

    fun ffi_mopro_example_app_rsa_rust_future_cancel_void(`handle`: Long): Unit

    fun ffi_mopro_example_app_rsa_rust_future_free_void(`handle`: Long): Unit

    fun ffi_mopro_example_app_rsa_rust_future_complete_void(
        `handle`: Long,
        uniffi_out_err: UniffiRustCallStatus,
    ): Unit
}
...
private fun uniffiCheckContractApiVersion(lib: IntegrityCheckingUniffiLib) {
    ...
    val scaffolding_contract_version = lib.ffi_mopro_example_app_rsa_uniffi_contract_version()
...
private fun uniffiCheckApiChecksums(lib: IntegrityCheckingUniffiLib) {
    if (lib.uniffi_mopro_example_app_rsa_checksum_func_generate_circom_proof() != 18036.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_mopro_example_app_rsa_checksum_func_generate_halo2_proof() != 2252.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_mopro_example_app_rsa_checksum_func_generate_noir_proof() != 65329.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_mopro_example_app_rsa_checksum_func_prove_rsa_simple() != 62967.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_mopro_example_app_rsa_checksum_func_verify_circom_proof() != 20320.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_mopro_example_app_rsa_checksum_func_verify_halo2_proof() != 26388.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_mopro_example_app_rsa_checksum_func_verify_noir_proof() != 23376.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_mopro_example_app_rsa_checksum_func_verify_rsa_simple() != 38286.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
}
...
fun `generateCircomProof`(
    ...
    FfiConverterTypeCircomProofResult.lift(
        uniffiRustCallWithError(MoproException) { _status ->
            UniffiLib.INSTANCE.uniffi_mopro_example_app_rsa_fn_func_generate_circom_proof(
...
fun `generateHalo2Proof`(
    ...
    FfiConverterTypeHalo2ProofResult.lift(
        uniffiRustCallWithError(MoproException) { _status ->
            UniffiLib.INSTANCE.uniffi_mopro_example_app_rsa_fn_func_generate_halo2_proof(
...
fun `generateNoirProof`(
    ...
    FfiConverterByteArray.lift(
        uniffiRustCallWithError(MoproException) { _status ->
            UniffiLib.INSTANCE.uniffi_mopro_example_app_rsa_fn_func_generate_noir_proof(
...
fun `proveRsaSimple`(
    ...
    FfiConverterByteArray.lift(
        uniffiRustCall { _status ->
            UniffiLib.INSTANCE.uniffi_mopro_example_app_rsa_fn_func_prove_rsa_simple(
                FfiConverterString.lower(`srsPath`),
                FfiConverterSequenceString.lower(`inputs`),
                _status,
            )
...
fun `verifyCircomProof`(
    ...
    FfiConverterBoolean.lift(
        uniffiRustCallWithError(MoproException) { _status ->
            UniffiLib.INSTANCE.uniffi_mopro_example_app_rsa_fn_func_verify_circom_proof(
                FfiConverterString.lower(`zkeyPath`),
...
fun `verifyHalo2Proof`(
    ...
    FfiConverterBoolean.lift(
        uniffiRustCallWithError(MoproException) { _status ->
            UniffiLib.INSTANCE.uniffi_mopro_example_app_rsa_fn_func_verify_halo2_proof(
                FfiConverterString.lower(`srsPath`),
...
fun `verifyNoirProof`(
    ...
    FfiConverterBoolean.lift(
        uniffiRustCallWithError(MoproException) { _status ->
            UniffiLib.INSTANCE.uniffi_mopro_example_app_rsa_fn_func_verify_noir_proof(
                FfiConverterString.lower(`circuitPath`),
                FfiConverterByteArray.lower(`proof`),
                _status,
            )
...
fun `verifyRsaSimple`(
    ...
    FfiConverterBoolean.lift(
        uniffiRustCall { _status ->
            UniffiLib.INSTANCE.uniffi_mopro_example_app_rsa_fn_func_verify_rsa_simple(
                FfiConverterString.lower(`srsPath`),
                FfiConverterByteArray.lower(`proof`),
                _status,
            )
